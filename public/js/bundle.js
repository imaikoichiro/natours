...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW1haWtvaWNoaXJvIiwiYSI6ImNsMXdycTZlNjA4NjUzY21rbDBmdDQ0YWcifQ.qZiTpyi9Nmwu9KTC9TMOrA';
  var map = new mapboxgl.Map({
    container: 'map',
    // style: 'mapbox://styles/mapbox/streets-v11',
    style: 'mapbox://styles/imaikoichiro/cl1wtarge00c514o9q0y9rqni',
    scrollZoom: false // center: [-118.115811, 34.093104],
    // zoom: 7,
    // interactive: false,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Erro logging out! Try again.');
...
var stripe = Stripe('pk_test_51KtJgMHgMrpT18GtvRA5rzlTqRQTnx9Ba9IqqK3HwGv4cyOPKuJexQz53s8TYB0JsMrZHYoDCnXVngat44ewQ3Mh00un41ERHm');
